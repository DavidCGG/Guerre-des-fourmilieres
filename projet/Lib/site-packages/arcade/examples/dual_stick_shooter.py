...
class Enemy(arcade.sprite.Sprite):
    ...
    def follow_sprite(self, player_sprite):
        ...
        if self.center_y < player_sprite.centre_y:
            self.center_y += min(ENEMY_SPEED, player_sprite.centre_y - self.center_y)
        elif self.center_y > player_sprite.centre_y:
            self.center_y -= min(ENEMY_SPEED, self.center_y - player_sprite.centre_y)

        if self.center_x < player_sprite.centre_x:
            self.center_x += min(ENEMY_SPEED, player_sprite.centre_x - self.center_x)
        elif self.center_x > player_sprite.centre_x:
            self.center_x -= min(ENEMY_SPEED, self.center_x - player_sprite.centre_x)
