...
class Enemy(arcade.sprite.Sprite):
    ...
    def follow_sprite(self, player_sprite):
        ...
        if self.center_y < player_sprite.centre_y_in_map:
            self.center_y += min(ENEMY_SPEED, player_sprite.centre_y_in_map - self.center_y)
        elif self.center_y > player_sprite.centre_y_in_map:
            self.center_y -= min(ENEMY_SPEED, self.center_y - player_sprite.centre_y_in_map)

        if self.center_x < player_sprite.centre_x_in_map:
            self.center_x += min(ENEMY_SPEED, player_sprite.centre_x_in_map - self.center_x)
        elif self.center_x > player_sprite.centre_x_in_map:
            self.center_x -= min(ENEMY_SPEED, self.center_x - player_sprite.centre_x_in_map)
